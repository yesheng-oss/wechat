...
这个仓库当前保存的是 `wxauto 3.9` 归档版本源码，适合学习桌面自动化、研究微信 PC 客户端交互逻辑，或在受控环境中进行二次开发。
...
本项目仅供技术研究、学习交流与自动化能力验证使用。

请勿将其用于任何违反法律法规、平台规则、隐私约定或未经授权的场景；因不当使用造成的任何后果，由使用者自行承担。

## 联系方式

- 文档站点：[https://docs.wxauto.org](https://docs.wxauto.org)
- 项目主页：[https://wxauto.org](https://wxauto.org)
